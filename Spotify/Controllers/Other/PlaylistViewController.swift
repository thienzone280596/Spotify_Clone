...
class PlaylistViewController: UIViewController {
    ...
    private let collectionView = UICollectionView(frame: .zero, collectionViewLayout: UICollectionViewCompositionalLayout(sectionProvider: { _, _ -> NSCollectionLayoutSection? in
        ...
        //Tao Pha khung phia tren collectionview
    ...
    override func viewDidLoad() {
        ...
        APICaller.shared.getPlaylistDetails(for: playlists) {[weak self] result in
    ...
    @objc func didTapShare() {
        guard let url = URL(string: playlists.external_urls["spotify"] ?? "") else {
            return
        }
...
extension PlaylistViewController: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
        ...
        let headerViewModel = PlaylistHeaderViewViewModel(
            name: playlists.name,
            ownerName: playlists.owner.display_name,
